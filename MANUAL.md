...
```
git clone https://github.com/Goayandi/android_device_xiaomi_cappu -b lineage-14.1 device/xiaomi/cappu
git clone https://github.com/Goayandi/android_device_mediatek_mt8173-common -b lineage-14.1 device/mediatek/mt8173-common
git clone https://github.com/Goayandi/android_vendor_xiaomi_cappu -b lineage-14.1 vendor/xiaomi/cappu
git clone https://github.com/Goayandi/android_kernel_xiaomi_cappu kernel/xiaomi/cappu -b yael kernel/xiaomi/cappu
```
## Building Source
